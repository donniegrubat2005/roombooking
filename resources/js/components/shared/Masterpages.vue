<template>
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Facility Settings Collapse Menu -->
      <li class="nav-item">
        <a
          class="nav-link collapsed"
          href="#"
          data-toggle="collapse"
          data-target="#facility"
          aria-expanded="true"
        ...
        >
          <div class="bg-white py-2 collapse-inner rounded">
            <router-link to="/managefacilities/list" class="collapse-item">Manage Facility</router-link>
            <a class="collapse-item" href="#">Assign Facility</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Room Settings Collapse Menu -->
      <li class="nav-item">
        <a
          class="nav-link collapsed"
          href="#"
